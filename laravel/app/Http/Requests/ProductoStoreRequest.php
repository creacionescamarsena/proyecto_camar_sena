...
class ProductoStoreRequest extends FormRequest
{
    ...
    {
        return [
            'id_chaqueta' => ['nullable', 'integer', 'min:1', 'unique:chaqueta,id_chaqueta'],
    ...
    public function messages(): array
    {
        return [
            ...
            'id_chaqueta.min' => 'El ID de chaqueta debe ser un número positivo (dejar vacío para auto-generar).',
