...
<head>
  ...
  <title>Actualizar Usuario - Creaciones Camar</title>
...
<div class="content">
  ...
  <div class="d-flex justify-content-end mb-3">
    <a href="usu_admin.html" class="btn btn-outline-secondary">
  ...
  <div class="card card-custom p-4">
    ...
    <form>
      <div class="row g-3">
        ...
        <div class="col-12 col-md-6">
          <label class="form-label">Apellidos de usuario</label>
        ...
        <div class="col-12 col-md-6">
          ...
          <input type="tel" class="form-control" value="3001234567">
        </div>
      ...
      <div class="d-flex justify-content-center gap-3 mt-4">
        <a href="usu_admin.html" class="btn btn-outline-secondary px-4">Cancelar</a>
