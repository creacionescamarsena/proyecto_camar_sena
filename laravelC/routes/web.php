...
foreach ($carrito as $item) {
    ...
    'total_convertido' => $request->total_convertido,
    'envio_convertido' => $request->envio_convertido,
...
return (object) [
    ...
    'total' => (float) $factura->total,
    'total_convertido' => (float) $factura->total_convertido,
    'envio_convertido' => (float) $factura->envio_convertido,
